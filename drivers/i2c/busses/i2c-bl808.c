...
static void bl808_fill_tx_fifo(struct bl808_i2c_dev *i2c_dev)
{
	...
	tx_fifo_free = (val & BL808_I2C_FIFO_CONFIG_1_TX_FIFO_CNT_MASK)
					>> BL808_I2C_FIFO_CONFIG_1_TX_FIFO_CNT_SHIFT;
...
static void bl808_drain_rx_fifo(struct bl808_i2c_dev *i2c_dev)
{
	...
	rx_fifo_free = (val & BL808_I2C_FIFO_CONFIG_1_RX_FIFO_CNT_MASK)
					>> BL808_I2C_FIFO_CONFIG_1_RX_FIFO_CNT_SHIFT;
...
static void bl808_i2c_set_datalen(struct bl808_i2c_dev *i2c_dev, u16 data_len)
{
	...
	val |= ((data_len - 1) << BL808_I2C_CONFIG_PKT_LEN_SHIFT)
			& BL808_I2C_CONFIG_PKT_LEN_MASK;
	bl808_i2c_writel(i2c_dev, BL808_I2C_CONFIG, val);
}
...
static irqreturn_t bl808_i2c_isr(int this_isq, void *data)
{
	...
	if (val & BL808_I2C_STS_ARB_INT) {
		...
		tx_cnt = (config_1 & BL808_I2C_FIFO_CONFIG_1_TX_FIFO_CNT_MASK)
						>> BL808_I2C_FIFO_CONFIG_1_TX_FIFO_CNT_SHIFT;
		rx_cnt = (config_1 & BL808_I2C_FIFO_CONFIG_1_RX_FIFO_CNT_MASK)
						>> BL808_I2C_FIFO_CONFIG_1_RX_FIFO_CNT_SHIFT;
